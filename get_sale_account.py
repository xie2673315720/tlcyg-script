# 获取畅易阁指定区服的交易区账号信息，并保存的sqlite的表中
# 作者 xhl
...
def sqlite_create_table():
    table_name = "tl_sale_account_" + datetime.now().strftime("%m_%d__%H_%M")
...
def get_account(pg_num):
    url = ("http://tl.cyg.changyou.com/goods/selling?world_id=3145&world_name=%25E7%258B%2582%25E6%2588%2598%25E5%25A4%25A9%25E4%25B8%258B&area_name=%25E5%2594%25AF%25E7%25BE%258E%25E7%2594%25B5%25E4%25BF%25A1&have_chosen=&page_num={}#goodsTag".format(pg_num))
    headers = {
